...
if __name__ == '__main__':
    ...
    data_mean = data_mean = np.mean(train_data)
    # TODO: compute the covariance matrix of train_data 
    data_cov = np.cov(m=train_data, rowvar=False)
    ...
    train_data = (train_data - data_mean) @ u[:,0:10]
    val_data = (val_data - data_mean) @ u[:,0:10]
