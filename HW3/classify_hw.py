...
if __name__ == '__main__':
    ...
    parser.add_argument('--feat_dim', type=int, default=2, help='dim of features')
    ...
    if opt.mode == 'hinge':
        ...
        W, b, sv = libsvm(opt.train_file_path, opt.val_file_path, opt.C, opt.feat_dim)

    else:
        print('mode should be hinge or baseline')
